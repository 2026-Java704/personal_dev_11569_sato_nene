...
public class MedicineController {
	...
	private final List<String> medicineMasterList = Arrays.asList(
			"PL顆粒", "アズノール", "アスベリン", "アセトアミノフェン", "アトルバスタチン", "アムロジピン",
			"アモキシシリン", "アレグラ", "アレロック", "アンブロキソール", "イソジン", "イナビル",
			"イブプロフェン", "エスタック", "エリキュース", "オノン", "オルパタジン", "オロパタジン",
			"ガスター", "ガスモチン", "カルボシステイン", "カルボプラチン", "カロナール", "カンデサルタン",
			"クラリスロマイシン", "クラリチン", "クレストール", "ゲンタシン", "コーラック", "ザイザル",
			"ジスロマック", "ジャディアンス", "ジルテック", "ストッパ", "セデス", "セフカペン", "センノシド",
			"ゾフルーザ", "タイレノール", "タケキャブ", "タミフル", "タリオン", "チョコラBB", "トラネキサム酸",
			"トラムセット", "ナロンエース", "ネキシウム", "ノーシン", "ハイチオール", "バファリン", "パブロン",
			"パリエット", "ビオフェルミン", "ビソルボン", "ビタメジン", "ヒルドイド", "フェキソフェナジン",
			"フォシーガ", "フスコデ", "ブスコパン", "プリンペラン", "フルナーゼ", "プレコール", "フロセミド",
			"ベンザブロック", "ポララミン", "ボルタレン", "マグミット", "ミヤBM", "ムコスタ", "ムコダイン",
			"メインテート", "メジコン", "メチコバール", "メトホルミン", "モーラステープ", "モンテルカスト",
			"ユベラ", "ラキソベロン", "ラックビー", "ラベプラゾール", "リリカ", "リレンザ", "リンデロン",
			"リンデロンVG", "ルル", "レボフロキサシン", "ロキソニン", "ロキソニンテープ", "ロキソプロフェン",
			"ワルファリン", "葛根湯", "五苓散", "酸化マグネシウム", "小青竜湯", "正露丸", "補中益気湯", "麻黄湯",
			"六君子湯", "芍薬甘草湯");
